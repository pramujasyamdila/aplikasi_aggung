...
class Master extends CI_Controller
{
    ...
    function edit_produk_page($id_produk)
    {
        ...
        $data['row_produk'] = $this->Global_model->by_id_produk($id_produk);
        $this->load->view('template/header', $data);
        $this->load->view('template/navbar', $data);
        $this->load->view('template/sidebar');
    ...
    function pembayaran_cod($no_order)
    {
        ...
        $data['row_detail_produk'] = $this->Global_model->by_row_produk_transaksi($no_order);
        $data['result_detail_produk'] = $this->Global_model->by_result_produk_transaksi($no_order);
        $this->load->view('template/header', $data);
    ...
    {
        $resultss = $this->Global_model->get_table_produk();
        $data = [];
        $no = $_POST['start'];
        foreach ($resultss as $angga) {
            $row = array();
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Global_model->count_all_data_produk(),
            "recordsFiltered" => $this->Global_model->count_filtered_data_produk(),
            "data" => $data
        );
        $this->output->set_content_type('application/json')->set_output(json_encode($output));
    }
    ...
    {
        $resultss = $this->Global_model->get_table_produk_gambar($id_produk);
        $data = [];
        $no = $_POST['start'];
        foreach ($resultss as $angga) {
            $row = array();
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Global_model->count_all_data_produk_gambar($id_produk),
            "recordsFiltered" => $this->Global_model->count_filtered_data_produk_gambar($id_produk),
            "data" => $data
        );
        $this->output->set_content_type('application/json')->set_output(json_encode($output));
    }
    ...
    public function by_id_produk($id_produk)
    {
        ...
        $get_produk = $this->Global_model->by_id_produk($id_produk);
        $output = [
    ...
    public function by_id_produk_gambar($id_detail_gambar_produk)
    {
        ...
        $get_produk_gambar = $this->Global_model->by_id_produk_gambar($id_detail_gambar_produk);
        $output = [
    ...
    public function tambah_produk()
    {
        ...
        if ($this->upload->do_upload('foto_produk')) {
            ...
            $this->Global_model->add_produk($upload);
            $this->output->set_content_type('application/json')->set_output(json_encode('success'));
        } else {
    ...
    public function tambah_produk_gambar()
    {
        ...
        if ($this->upload->do_upload('foto_detail_produk')) {
            ...
            $this->Global_model->add_produk_gambar($upload);
            $this->output->set_content_type('application/json')->set_output(json_encode('success'));
        } else {
            $this->session->set_flashdata('error', $this->upload->display_errors());
            redirect(base_url('upload'));
    ...
    {
        $this->Global_model->delete_produk($id_produk);
        $this->output->set_content_type('application/json')->set_output(json_encode('success'));
    }

    public function hapus_produk_gambar($id_detail_gambar_produk)
    {
        $this->Global_model->delete_produk_gambar($id_detail_gambar_produk);
        $this->output->set_content_type('application/json')->set_output(json_encode('success'));
    }
    public function edit_produk()
    {
        ...
        if ($this->upload->do_upload('foto_produk')) {
            ...
            $this->Global_model->update_produk($upload, $where);
            $this->output->set_content_type('application/json')->set_output(json_encode('success'));
        } else {
            $upload = [
                'nama_produk' => $nama_produk,
    ...
    function PembayaranBerhasil()
    {
        ...
        if ($callbackKey === $validKey) {
            ...
            foreach ($result_detail_transaksi as $key => $value) {
                ...
                $result_trx_produk = $this->Global_model->result_trx_produk($jumlah_pesanan, $id_produk);
                foreach ($result_trx_produk as $key => $value_trx) {
                    ...
                    $this->Global_model->insert_ke_produk_user($data_insert_ke_produk_user);
                }
                $data_update_trx_produk = [
                    'sts_terjual' => 1,
                ];
                $this->Global_model->update_ke_trx_produk($jumlah_pesanan, $id_produk, $data_update_trx_produk);
            }
    ...
    public function pembayaran_cod_view()
    {
        ...
        $data['pembayaran'] = $this->Global_model->result_pembayaran();
        $this->load->view('template/header', $data);
        $this->load->view('template/navbar', $data);
        $this->load->view('template/sidebar');
    ...
    {
        $row = $this->Global_model->row_pembayaran($id_transaksi);
        $where = [
            'id_transaksi' => $id_transaksi
        ];
        $datakirim = [
