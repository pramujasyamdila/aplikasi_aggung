                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <h4 class="text-white">Data divisi</h4>
                                ...
                                <table id="table" class="table table-bordered">
                                    <thead class="text-center">
                                        <tr class="bg-primary">
                                            ...
                                            <th class="text-white">Kode divisi</th>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_divisi" required class="form-control" placeholder="Masukan Kode divisi">
                        </div>
                        <div class="form-group">
                            <label for="">Nama divisi</label>
                            <input type="text" name="nama_divisi" required class="form-control" placeholder="Nama divisi...">
                        </div>
                    </div>
                </div>
