...
<div class="container">
    <div class="screen">
        <div class="screen__content">
            ...
            <div>
                <img style="width: 150px;padding:20px" src="<?= base_url('assets/JMTM.png') ?>" alt="">
            </div>
            ...
            <div class="login__field">
                ...
                <input type="hidden" name="otp_verifikasi2" value="<?= $this->session->userdata('otp_qrcode'); ?>" style="padding-left:40px;font-size:20px;" class="login__input" placeholder="Masukan Kode Otp">
