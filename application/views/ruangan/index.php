                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <h4 class="text-white">Data ruangan</h4>
                                ...
                                <table id="table" class="table table-bordered">
                                    <thead class="text-center">
                                        <tr class="bg-primary">
                                            ...
                                            <th class="text-white">Kode ruangan</th>
                                            <th class="text-white">Nama ruangan</th>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_ruangan" required class="form-control" placeholder="Masukan Kode ruangan">
                        </div>
                        <div class="form-group">
                            <label for="">Nama ruangan</label>
                            <input type="text" name="nama_ruangan" required class="form-control" placeholder="Nama ruangan...">
                        </div>
                    </div>
                </div>
