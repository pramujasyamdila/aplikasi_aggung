                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <h4 class="text-white">EDIT HOTEL</h4>
                        </div>
                        <div class="card-body">
                            <form action="javascript:;" id="form_edit" method="post">
                                <div class="modal-body">
                                    <div class="container-fluid">
                                    <input type="hidden" value="<?= $row_user['id_user']?>" name="id_user" required class="form-control" placeholder="Nama Hotel...">

                                        <div class="form-group">
                                            <label for="">Nama Hotel</label>
                                            <input type="text" value="<?= $row_user['nama_user']?>" name="nama_user" required class="form-control" placeholder="Nama Hotel...">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="<?= base_url('genetika/user')?>" class="btn btn-secondary">Kembali</a>
                                </div>
                            </form>
                        </div>
                    </div>
