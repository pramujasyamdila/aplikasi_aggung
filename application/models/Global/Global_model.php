...
class Global_model extends CI_Model
{
    ...
    private function _get_data_query_iklan()
    {
        ...
        $this->db->join('tbl_produk', 'tbl_iklan.id_produk = tbl_produk.id_produk', 'left');
        $this->db->order_by('tbl_iklan.id_iklan', 'DESC');
    }
    ...
    public function by_id_iklan($id_iklan)
    {
        ...
        $this->db->from('tbl_iklan');
        $this->db->join('tbl_produk', 'tbl_iklan.id_produk = tbl_produk.id_produk', 'left');
        $this->db->where('tbl_iklan.id_iklan', $id_iklan);
        $query = $this->db->get();
        return $query->row_array();
    }
    ...
    {
        $this->db->delete('tbl_iklan', ['id_iklan' => $id_iklan]);
    }


    public function update_iklan($data, $where)
    {
        $this->db->update('tbl_iklan', $data, $where);
    }
    ...
    public function result_iklan()
    {
        ...
        $this->db->from('tbl_iklan');
        $this->db->join('tbl_produk', 'tbl_iklan.id_produk = tbl_produk.id_produk', 'left');
        $this->db->where('tbl_iklan.jenis_iklan', 'produk');
    ...
    public function result_iklan_langganan()
    {
        ...
        $this->db->from('tbl_iklan');
        $this->db->join('tbl_produk', 'tbl_iklan.id_produk = tbl_produk.id_produk', 'left');
        $this->db->where('tbl_iklan.jenis_iklan', 'langganan');
        $this->db->order_by('id_iklan', 'DESC');
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    private function _get_data_query_user_konter()
    {
        $this->db->select('*');
        $this->db->from('tbl_user');
        $this->db->join('tbl_lokasi', 'tbl_user.id_lokasi = tbl_lokasi.id_lokasi', 'left');
        $this->db->order_by('tbl_user.id_user', 'DESC');
        $this->db->where('tbl_user.id_role', 2);
    }
    ...
    private function _get_data_query_user_umum()
    {
        ...
        $this->db->from('tbl_user');
        $this->db->order_by('tbl_user.id_user', 'DESC');
        $this->db->where('tbl_user.id_role', 3);
    }
    ...
    private function _get_data_query_user_bulanan()
    {
        ...
        $this->db->from('tbl_user');
        $this->db->order_by('tbl_user.id_user', 'DESC');
        $this->db->where('tbl_user.id_role', 4);
        $this->db->where('tbl_user.status_berlangganan', 1);
    }
    ...
    private function _get_data_query_user_bulanan_langganan()
    {
        ...
        $this->db->order_by('tbl_user.id_user', 'DESC');
        $this->db->where('tbl_user.id_role', 4);
        $this->db->where('tbl_user.status_berlangganan', 2);
    }
    ...
    {
        $this->db->select('*');
        $this->db->from('tbl_detail_gambar_produk');
        $this->db->where('id_produk', $id_produk);
        $this->db->order_by('tbl_detail_gambar_produk.id_produk', 'DESC');
    }
    ...
    private function _get_data_query_produk_mitra($id_user)
    {
        $this->db->select('*');
        $this->db->from('tbl_produk');
        $this->db->where('tbl_produk.id_user', $id_user);
        $this->db->order_by('tbl_produk.id_produk', 'DESC');
    }
    ...
    {
        $this->db->insert('tbl_detail_gambar_produk', $data);
        return $this->db->affected_rows();
    }
    ...
    public function by_id_produk_gambar($id_detail_gambar_produk)
    {
        $this->db->select('*');
        $this->db->from('tbl_detail_gambar_produk');
        $this->db->where('tbl_detail_gambar_produk.id_detail_gambar_produk', $id_detail_gambar_produk);
        $query = $this->db->get();
        return $query->row_array();
    }
    ...
    public function result_produk()
    {
        $this->db->select('*');
        $this->db->from('tbl_produk');
        $this->db->join('tbl_user', 'tbl_produk.id_user = tbl_user.id_user', 'left');
    ...
    {
        $this->db->delete('tbl_detail_gambar_produk', ['id_detail_gambar_produk' => $id_detail_gambar_produk]);
    }
    ...
    public function insert_produk($data)
    {
        $jumlah = count($data);
        if ($jumlah > 0) {
            $this->db->replace('tbl_produk', $data);
        }
    }
    ...
    public function row_produk_gambar($id_produk)
    {
        $this->db->select('*');
        $this->db->from('tbl_detail_gambar_produk');
        $this->db->join('tbl_produk', 'tbl_detail_gambar_produk.id_produk = tbl_produk.id_produk', 'left');
        $this->db->where('tbl_detail_gambar_produk.id_produk', $id_produk);
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    {
        $this->db->select('*');
        $this->db->from('tbl_produk_keranjang');
        $this->db->where('id_produk', $id_produk);
        $this->db->where('id_user', $id_user);;
        $query = $this->db->get();
        return $query->row_array();
    ...
    public function cek_keranjnag_saya($id_user)
    {
        $this->db->select('*');
        $this->db->from('tbl_produk_keranjang');
        $this->db->join('tbl_produk', 'tbl_produk_keranjang.id_produk = tbl_produk.id_produk', 'left');
        $this->db->where('tbl_produk_keranjang.id_user', $id_user);;
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    {
        $this->db->select('*');
        $this->db->from('tbl_produk_transaksi');
        $this->db->where('tbl_produk_transaksi.no_order', $no_order);;
        $query = $this->db->get();
        return $query->row_array();
    }
    ...
    {
        $this->db->select('*');
        $this->db->from('tbl_produk_detail_transaksi');
        $this->db->join('tbl_produk', 'tbl_produk_detail_transaksi.id_produk = tbl_produk.id_produk', 'left');
        $this->db->where('tbl_produk_detail_transaksi.no_order', $no_order);;
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    {
        $this->db->insert('tbl_produk_keranjang', $data);
        return $this->db->affected_rows();
    }
    public function update_to_cart($where, $data)
    {
        $this->db->update('tbl_produk_keranjang', $data, $where);
        return $this->db->affected_rows();
    }

    public function update_ke_transaksi($data, $where)
    {
        $this->db->update('tbl_produk_transaksi', $data, $where);
        return $this->db->affected_rows();
    }
    ...
    {
        $this->db->delete('tbl_produk_keranjang', ['id_cart' => $id_cart]);
        return $this->db->affected_rows();
    }
    ...
    public function get_user_lamaran($id_lamaran)
    {
        $this->db->select('*');
    ...
    public function tambah_ke_tbl_produk_transaksi($data)
    {
        $this->db->insert('tbl_produk_transaksi', $data);
        return $this->db->affected_rows();
    }

    public function tambah_ke_tbl_produk_detail_transaksi($data)
    {
        $this->db->insert('tbl_produk_detail_transaksi', $data);
        return $this->db->affected_rows();
    }
    ...
    public function result_orderan_pemebeli($id_user)
    {
        $this->db->select('*');
        $this->db->from('tbl_produk_transaksi');
        $this->db->join('tbl_user', 'tbl_produk_transaksi.id_user = tbl_user.id_user', 'left');
        $this->db->where('tbl_produk_transaksi.id_user', $id_user);
        $this->db->where('tbl_produk_transaksi.sts_pembayaran', 'PENDING');
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    public function result_orderan_prosess_pembeli($id_user)
    {
        ...
        $this->db->join('tbl_user', 'tbl_produk_transaksi.id_user = tbl_user.id_user', 'left');
        $this->db->where('tbl_produk_transaksi.id_user', $id_user);
        $this->db->where('tbl_produk_transaksi.sts_pembayaran', 'PAID');
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    public function result_orderan_pembayarn_pembeli($id_user)
    {
        ...
        $this->db->join('tbl_user', 'tbl_produk_transaksi.id_user = tbl_user.id_user', 'left');
        $this->db->where('tbl_produk_transaksi.id_user', $id_user);
        $this->db->where('tbl_produk_transaksi.sts_pembayaran', 3);
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    {
        $this->db->insert('tbl_detail_rating', $data);
        return $this->db->affected_rows();
    }
    ...
    public function get_rating($id_produk)
    {
        ...
        $this->db->from('tbl_detail_rating');
        $this->db->where('id_produk', $id_produk);
        $query = $this->db->get();
        return $query->row_array();
    }
    public function get_komentar($id_produk)
    {
        $this->db->select('*');
        $this->db->from('tbl_detail_rating');
        $this->db->join('tbl_user', 'tbl_detail_rating.id_user = tbl_user.id_user', 'left');
        $this->db->where('tbl_detail_rating.id_produk', $id_produk);
    ...
    {
        $this->db->select('*');
        $this->db->from('tbl_paket_bulanan_pilihan');
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    public function result_my_produk($id_user)
    {
        ...
        $this->db->from('tbl_produk_transaksi');
        $this->db->where('tbl_produk_transaksi.id_user', $id_user);
        $this->db->where('tbl_produk_transaksi.sts_pencairan', 1);
        $query = $this->db->get();
        return $query->result_array();
    }
    public function count_my_produk($id_user)
    {
        $this->db->select('*');
        $this->db->from('tbl_produk_transaksi');
        $this->db->join('tbl_produk', 'tbl_produk_transaksi.id_produk = tbl_produk.id_produk', 'left');
        $this->db->where('tbl_produk_transaksi.id_user', $id_user);
        $query = $this->db->get();
        return $query->num_rows();
    }
    ...
    {
        $this->db->select('*');
        $this->db->from('tbl_riwayat_pembayaran_bulanan');
        $this->db->where('tbl_riwayat_pembayaran_bulanan.id_user', $id_user);
        $this->db->where('tbl_riwayat_pembayaran_bulanan.status_bayar', NULL);
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    public function result_riwayat_taggihan_prosess($id_user)
    {
        ...
        $this->db->from('tbl_riwayat_pembayaran_bulanan');
        $this->db->where('tbl_riwayat_pembayaran_bulanan.id_user', $id_user);
        $this->db->where('tbl_riwayat_pembayaran_bulanan.status_bayar', 2);
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    public function result_riwayat_taggihan_selesai($id_user)
    {
        ...
        $this->db->from('tbl_riwayat_pembayaran_bulanan');
        $this->db->where('tbl_riwayat_pembayaran_bulanan.id_user', $id_user);
        $this->db->where('tbl_riwayat_pembayaran_bulanan.status_bayar', 1);
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    public function result_riwayat_taggihan_detail($id_riwayat_pemabayaran)
    {
        $this->db->select('*');
        $this->db->from('tbl_riwayat_pembayaran_bulanan');
        $this->db->where('tbl_riwayat_pembayaran_bulanan.id_riwayat_pemabayaran', $id_riwayat_pemabayaran);
        $query = $this->db->get();
        return $query->row_array();
    }
    ...
    public function cek_pembayaran_registrasi($id_user)
    {
        ...
        $this->db->from('tbl_riwayat_pembayaran_bulanan');
        $this->db->where('tbl_riwayat_pembayaran_bulanan.id_user', $id_user);
        $this->db->where('tbl_riwayat_pembayaran_bulanan.jenis_taggihan', 'Pembayaran Registrasi');
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    public function cek_pembayaran_bulanan($id_user)
    {
        ...
        $this->db->from('tbl_riwayat_pembayaran_bulanan');
        $this->db->where('tbl_riwayat_pembayaran_bulanan.id_user', $id_user);
        $this->db->where('tbl_riwayat_pembayaran_bulanan.jenis_taggihan', 'Pembayaran Bulanan');
        $this->db->where('MONTH(tbl_riwayat_pembayaran_bulanan.tanggal_bayar)', date("m"));
        $query = $this->db->get();
        return $query->result_array();
    }
    ...
    {
        $this->db->insert('tbl_riwayat_pembayaran_bulanan', $data);
        return $this->db->affected_rows();
    }

    public function by_id_riwayat_pemabayaran($id_riwayat_pemabayaran)
    {
        $this->db->select('tbl_riwayat_pembayaran_bulanan.total_pembayaran,tbl_riwayat_pembayaran_bulanan.id_riwayat_pemabayaran,tbl_riwayat_pembayaran_bulanan.file,tbl_riwayat_pembayaran_bulanan.id_user,tbl_user.token_notif,tbl_user.nama_user,tbl_riwayat_pembayaran_bulanan.ket_pembayaran');
        $this->db->from('tbl_riwayat_pembayaran_bulanan');
        $this->db->join('tbl_user', 'tbl_riwayat_pembayaran_bulanan.id_user = tbl_user.id_user', 'right');
        $this->db->where('tbl_riwayat_pembayaran_bulanan.id_riwayat_pemabayaran', $id_riwayat_pemabayaran);
        $query = $this->db->get();
        return $query->row_array();
    }

    function update_tbl_riwayat_pembayaran_bulanan($data, $where)
    {
        $this->db->update('tbl_riwayat_pembayaran_bulanan', $data, $where);
    }
    ...
    public function count_riwayat_pembayaran_sudah_bayar()
    {
        $this->db->select('*');
        $this->db->from('tbl_riwayat_pembayaran_bulanan');
        $this->db->join('tbl_user', 'tbl_riwayat_pembayaran_bulanan.id_user = tbl_user.id_user', 'left');
        $this->db->where('tbl_riwayat_pembayaran_bulanan.status_bayar', 1);
        if (isset($_POST['status_bayar']) && $_POST['status_bayar'] != '') {
            if ($_POST['status_bayar'] == 3) {
                $this->db->where('tbl_riwayat_pembayaran_bulanan.status_bayar', NULL);
            } else {
                $this->db->where('tbl_riwayat_pembayaran_bulanan.status_bayar', $_POST['status_bayar']);
            }
        }
        if (isset($_POST['tanggal_bayar_awal'], $_POST['tanggal_bayar_akhir']) && $_POST['tanggal_bayar_awal'] != '' && $_POST['tanggal_bayar_akhir'] != '') {
            $this->db->where('tbl_riwayat_pembayaran_bulanan.tanggal_bayar >=', $_POST['tanggal_bayar_awal']);
            $this->db->where('tbl_riwayat_pembayaran_bulanan.tanggal_bayar <=', $_POST['tanggal_bayar_akhir']);
        } else {
        }
        $query = $this->db->get();
        return $query->num_rows();
    ...
    public function count_riwayat_pembayaran_sudah_bayar_pelanggan()
    {
        ...
        if (isset($_POST['status_bayar']) && $_POST['status_bayar'] != '') {
            if ($_POST['status_bayar'] == 'EXPIRED') {
                $this->db->where('tbl_produk_transaksi.sts_pembayaran', 'EXPIRED');
            } else {
                $this->db->where('tbl_produk_transaksi.sts_pembayaran', $_POST['status_bayar']);
            }
        }
        if (isset($_POST['tanggal_bayar_awal'], $_POST['tanggal_bayar_akhir']) && $_POST['tanggal_bayar_awal'] != '' && $_POST['tanggal_bayar_akhir'] != '') {
            $this->db->where('tbl_produk_transaksi.tanggal_bayar >=', $_POST['tanggal_bayar_awal']);
            $this->db->where('tbl_produk_transaksi.tanggal_bayar <=', $_POST['tanggal_bayar_akhir']);
        } else {
        }
        $query = $this->db->get();
        return $query->num_rows();
